...
class PunterSerializer(serializers.HyperlinkedModelSerializer):	
	...
	class Meta:
		model=Punter
		fields = ('username','first_name', 'last_name', 'cellphone', 'email','my_store')
...
class ManagerSerializer(serializers.HyperlinkedModelSerializer):	
	...
	class Meta:
		model = Manager
		fields = ('username','first_name', 'last_name', 'cpf','cellphone','address', 'email','commission','credit_limit_to_add','can_cancel_ticket','limit_time_to_cancel','can_sell_unlimited','can_change_limit_time','based_on_profit','my_store')
