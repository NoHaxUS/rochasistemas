def general_configurations(store):    
    ...
    return {"max_reward_to_pay":max_reward_to_pay,"min_number_of_choices_per_bet":min_number_of_choices_per_bet,"max_number_of_choices_per_bet":max_number_of_choices_per_bet,"min_bet_value":min_bet_value, "max_bet_value":max_bet_value}