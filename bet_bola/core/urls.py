...
from core.my_views.games import TodayGames, GamesTable, GamesTomorrow, GamesAfterTomorrow, GameAbleView, TodayGamesView, TomorrowGamesView, AfterTomorrowGamesView
