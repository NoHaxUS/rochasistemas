# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-11-25 20:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='cotation',
            name='status',
            field=models.CharField(choices=[('OPEN', 'Resultado em Aberto'), ('NOT_HAPPENED', 'Não aconteceu'), ('HAPPENED', 'Aconteceu')], default='OPEN', max_length=25),
        ),
        migrations.AlterField(
            model_name='game',
            name='status_game',
