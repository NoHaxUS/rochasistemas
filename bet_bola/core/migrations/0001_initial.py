# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-11-07 14:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('OPEN', 'open'), ('HAPPENING', 'happening'), ('NOT_HAPPENING', 'not_happening')], max_length=25)),
            ],
        ),
        migrations.CreateModel(
            name='Game',
        ...
        migrations.AddField(
            model_name='betticket',
            name='reward',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='core.Reward'),
        ),
        migrations.AddField(
            model_name='betticket',
            name='seller',
