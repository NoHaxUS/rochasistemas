    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reward_value', models.DecimalField(decimal_places=2, default=0, max_digits=50, verbose_name='Valor da Recompensa')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket_status', models.CharField(choices=[('Aguardando Resultados', 'Aguardando Resultados'), ('Não Venceu', 'Não Venceu'), ('Venceu', 'Venceu'), ('Venceu e não foi pago', 'Venceu e não foi pago'), ('Cancelado', 'Cancelado')], default='Aguardando Resultados', max_length=80, verbose_name='Status de Ticket')),
                ('is_visible', models.BooleanField(default=True, verbose_name='Visível?')),
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='my_tickets', to=settings.AUTH_USER_MODEL, verbose_name='Apostador')),
            ],
            options={
                'verbose_name': 'Ticket',
