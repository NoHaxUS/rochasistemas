# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-12-27 20:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bet_ticket_status', models.CharField(choices=[('WAITING_RESULT', 'Aguardando Resultados.'), ('NOT_WON', 'Não Venceu.'), ('WON', 'Venceu.')], default='Aguardando Resultados.', max_length=80)),
            ],
            options={
                'verbose_name': 'Ticket',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status_payment', models.CharField(choices=[('WATING_PAYMENT', 'Aguardando Pagamento do Ticket.'), ('PAID', 'Pago.')], default='Aguardando Pagamento do Ticket.', max_length=80)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_reward', models.CharField(choices=[('WAITING_RESULTS', 'Aguardando Resultados.'), ('PAID', 'Finalizado, O apostador foi pago.'), ('NOT_WON', 'Esse ticket não venceu.'), ('WON', 'Venceu, Aguardando pagamento.')], default='Aguardando Resultados.', max_length=80)),
