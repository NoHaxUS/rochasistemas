# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-11-20 11:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.DecimalField(decimal_places=2, max_digits=4)),
                ('status', models.CharField(choices=[('NOT_HAPPENED', 'Não aconteceu'), ('HAPPENED', 'Aconteceu'), ('OPEN', 'Resultado em Aberto')], max_length=25)),
            ],
        ),
        migrations.CreateModel(
            name='Game',
