# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-11-08 10:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('HOME', 'open'), ('TIE', 'tie'), ('AWAY', 'away')], max_length=25)),
            ],
        ),
        migrations.CreateModel(
            name='Game',
        ...
        migrations.AddField(
            model_name='betticket',
            name='payment',
            field=models.OneToOneField(blank=True, on_delete=django.db.models.deletion.CASCADE, to='core.Payment'),
        ),
        migrations.AddField(
            model_name='betticket',
            name='punter',
